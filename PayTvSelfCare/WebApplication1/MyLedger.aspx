<%@ Page Title="" Language="C#" MasterPageFile="~/PatTVMainMaster.Master" AutoEventWireup="true" CodeBehind="MyLedger.aspx.cs" Inherits="WebApplication1.MyLedger" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="js/fromjs/MyLedger.js?v=<%= System.Configuration.ConfigurationManager.AppSettings["ReleaseVersion"] %>.3"></script>
    ...
    <style type="text/css">
        ...
        .vertical-timeline-content h5 { font-weight: 500; color: #000; display: inline-block; font-size: 18px; margin: 6px 15px 12px 15px;text-transform: capitalize; }
                ...
                <div id="admin" class="col s12">
                    ...
                    <div id="DocView" style="display: none;">
                        ...
                        <div style="padding: 15px; font-size: 18px; padding-left: 0px; padding-right: 0px; width: 95%; margin: auto; padding-bottom: 0px;">
                            <a href="javascript:void(0);" onclick="javascript:BackToLedger(); return false;" style="float: left;"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Back</a>
                            <a href="javascript:void(0);" style="float: right;" onclick="javascript:DownloadDoc(); return false;"><i class="fa fa-download"></i>&nbsp;&nbsp;Download</a>
                    ...
                    <div class="card material-table" id="LedgerView" style="display: block;">
                        <div class="table-header">
                            <div class="row">
                                <div class="col s7" style="padding-top: 10px; padding-left: 0px;"><span class="table-title" id="LBalAmt"></span></div>
                                <div class="actions col m4" id="LedgerFilter">
                                    ...
                                    <a style="display: none" rel="nofollow" rel="noreferrer" href="javascript:void(0);" class="search-toggle waves-effect btn-flat nopadding"><i class="mdi-action-search">search</i></a>
                                   ...
                                   <%-- <div class="vertical-timeline-block ">
                                        ...
                                        <div class="vertical-timeline-content">
                                            <div class="upperdetails">
                                                <p id="P1">Receipt No. : 564OIU45</p>
                                                <p style="float: right; color: green" class="FullDrCr">Credit</p>
                                            </div>
                                            <div class="middledetails">
                                                <h5 id="H1">Money Added in Wallet</h5>
                                                <p style="float: right; font-weight: 600;"><i class="fa fa-inr"></i>&nbsp;&nbsp;&nbsp;300.00 <span class="RspDrCr">Cr</span></p>
                                            </div>
                                            <div class="bottomdetails">
                                                <p>By Net Banking</p>
                                                <p style="float: right;" id="P2">Closing Balance &nbsp;<i class="fa fa-inr"></i>&nbsp;&nbsp;<span>&nbsp;300.00 </span></p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="vertical-timeline-block ">
                                        ...
                                        <div class="vertical-timeline-content Content1Before">
                                            <div class="upperdetails">
                                                <p id="ReciptNo">Invoice No. : 564OIU45</p>
                                                <p style="float: right; color: red" class="FullDrCr">Debit</p>
                                            </div>
                                            <div class="middledetails">
                                                <h5 id="ProfileDue">BST Pack &nbsp;<span>(2-Oct-2019 To 1-Dec 2019)</span></h5>
                                                <p style="float: right; font-weight: 600;"><i class="fa fa-inr"></i>&nbsp;&nbsp;&nbsp;0.00 <span class="RspDrCr">Dr</span></p>
                                            </div>
                                            <div class="bottomdetails">
                                                <p>VC No. - 45698755RT4545</p>
                                                <p style="float: right;" id="Amount">Closing Balance &nbsp;<i class="fa fa-inr"></i>&nbsp;&nbsp;<span>&nbsp;300.00 </span></p>
                                            </div>
                                        </div>
                                    </div>--%>
