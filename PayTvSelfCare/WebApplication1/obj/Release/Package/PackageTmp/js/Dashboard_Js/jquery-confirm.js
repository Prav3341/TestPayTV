...
(function ($) {
    ...
    Jconfirm.prototype = {
        ...
        _open: function () {
            ...
            if (MsgType == "Success") {
                ...
                $(".jconfirm-Notification").css("display", "none");
                $('.jconfirm-buttons').removeClass('ConfirmBtn');
                $(".jconfirm-SucessMsgicon").css("display", "block");
                $(".jconfirm-ErrorMsgicon").css("display", "none");
                MsgConfirm = false;
            }
            else {

                $(".jconfirm-SucessMsgicon").css("display", "none");
                $(".jconfirm-Notification").css("display", "none");
                $('.jconfirm-buttons').removeClass('ConfirmBtn');
                $(".jconfirm-ErrorMsgicon").css("display", "block");
            }

            if (MsgConfirm == true) {
                $('.jconfirm-buttons').addClass('ConfirmBtn');
                $('.jconfirm-SucessMsgicon').css('display', 'none');
                $('.jconfirm-ErrorMsgicon').css('display', 'none');
                $('.jconfirm-Notification').css('display', 'block');
            }
            else {
                $('.jconfirm-buttons').removeClass('ConfirmBtn');
    ...
    jconfirm.pluginDefaults = {
        ...
        '<span class="jconfirm-title"></span></div>' +
         '<div class="jconfirm-SucessMsgicon"><img src="images/others/SuccessMasg.png" /></div>' +
        '<div class="jconfirm-ErrorMsgicon"><img src="images/others/ErrorMasg.png" /></div>' +
        '<div class="jconfirm-Notification"><img src="images/others/NotificationMasg.png" /></div>' +
        '<div class="jconfirm-content-pane">' +
        '<div class="jconfirm-content"></div>' +
        '<div class="jconfirm-clear"></div>' +
        '</div>' +
        '<div class="jconfirm-buttonsMain">' +
