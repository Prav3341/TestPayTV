...
$(window).load(function () {
    ...
    var FromDate = firstDay.toString().split(" ")[2] + "-" + firstDay.toString().split(" ")[1] + "-" + firstDay.toString().split(" ")[3];
    //var FromDate = firstDay.toString().split(" ")[2] + "-" + firstDay.toString().split(" ")[1] + "-" + firstDay.toString().split(" ")[3] + firstDay.toString().split(" ")[4];
    var ToDate = lastDay.toString().split(" ")[2] + "-" + lastDay.toString().split(" ")[1] + "-" + lastDay.toString().split(" ")[3] + " 23:59:59";
